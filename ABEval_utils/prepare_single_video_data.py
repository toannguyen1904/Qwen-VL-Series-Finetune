...
# Just a file to test the single video data preparation to see if the code is working
...
def main():
    ...
    train_path = OUTPUT_DIR / "single_video_train.json"
    test_path = OUTPUT_DIR / "single_video_test.json"
